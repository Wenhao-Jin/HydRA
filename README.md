...
# <a name="data_preparation"></a>Prepare the input data
### Protein sequences
...
# <a name="TrainNewModel"></a>Train a new HydRA model
...
# <a name="TrainAndEvaluate"></a>Train and evaluate a new HydRA model
