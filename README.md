...
```
Download ProteinBERT-RBP model (i.e. ProteinBERT_TrainWithWholeProteinSet_defaultSetting_ModelFile.pkl.gz) from the assets of Releases v0.1.21.36 in this repository [here](https://github.com/Wenhao-Jin/HydRA/releases/download/v0.1.21.36/ProteinBERT_TrainWithWholeProteinSet_defaultSetting_ModelFile.pkl). (If you are Yeo Lab TSCC user, skip this step.) 
